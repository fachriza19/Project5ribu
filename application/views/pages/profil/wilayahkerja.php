  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
          <div class="card-body">
          <img src="<?php echo base_url('assets/images/logwilker.png'); ?>" width="100%">
          <br/><br/><br/>
            <div class="text-center"><img src="<?php echo base_url('assets/images/wilker.png')?>" width="100%"></div>
            <br /><br />
            ...
            <ul class="list-icons">
              <li>
                <h5><i class="ti-angle-right"></i>Sebelah Utara	: Laut Cina Selatan dan Provinsi  Kalimantan Barat</h5>
              </li>
              <li>
                <h5><i class="ti-angle-right"></i>Sebelah Selatan	: Samudera Hindia</h5>
              </li>
              <li>
                <h5><i class="ti-angle-right"></i>Sebelah Timur	: Laut Jawa dan Provinsi Jawa Tengah</h5>
              </li>
              <li>
                <h5><i class="ti-angle-right"></i>Sebelah Barat	: Samudera Hindia dan Provinsi Sumatera Selatan (Palembang)</h5>
              </li>
            </ul>
            <br>
            ...
            <div class="text-center"><img src="<?php echo base_url('assets/images/tabwilker.png')?>" width="100%"></div>
          </div>
        </div>
      </div>
    </div>
