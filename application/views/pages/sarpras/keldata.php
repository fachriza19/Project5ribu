...
<form action="<?php echo base_url('adminmenu/tambahdata'); ?>" method="post">
  ...
  <div class="form-group row">
    ...
    <div class="col-10">
      <input class="form-control" type="text" placeholder="Contoh : TG. PRIOK No.2 " name="nama" id="inputnamaSBNP"required>
    </div>
  </div>
  <div class="form-group row">
  ...
  <div class="form-group row">
    ...
    <div class="col-10">
      <input class="form-control" type="text" placeholder="Contoh : Tidak Tetap " name="stt" required>
    </div>
  </div>
  <div class="form-group row">
